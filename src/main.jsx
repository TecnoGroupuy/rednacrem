                    ...
                    {(() => {
                      ...
                      return (
                        <>
                          ...
                          <td style={{ color: '#64748b', fontSize: 12, whiteSpace: 'nowrap' }}>
                            {(() => {
                              const fecha = contact.fecha_lead || contact.created_at;
                              return fecha
                        ...
                        <div style={{ fontSize: 13, display: 'flex', flexDirection: 'column', gap: 8 }}>
                          ...
                          <div style={{ marginTop: 8, padding: '12px 16px', background: 'var(--surface)', borderRadius: 8, border: '1px solid var(--line)' }}>
                            ...
                            <div style={{ fontFamily: 'monospace', fontSize: 12, marginTop: 4 }}>
                              organization_id: <strong>"{activeOrgId || ''}"</strong>
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          <tr key={row.productId ? `${row.id}-${row.productId}` : (row.id || `client-${index}`)}>
            ...
            <td className="col-accion">
              <div className="clients-actions">
                <Button className="clients-action-btn clients-action-btn--view" variant="ghost" icon={<Eye size={15} />} onClick={() => handleViewFicha(row.id, row.productId)}>Ver ficha</Button>
